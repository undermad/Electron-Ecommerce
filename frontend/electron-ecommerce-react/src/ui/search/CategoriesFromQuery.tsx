...
type CategoriesFromQuery = {
    categories: Set<string>,
}

export const CategoriesFromQuery = ({categories}: CategoriesFromQuery) => {
                    ...
                    <div className={"h-full flex flex-col overflow-y-auto"}
                        ...
                        <div className={"flex justify-between mb-1 border-b border-electron-product-listing-bg"}>
                            <div className={"w-5/6 px-4 py-2"}>
                                ...
                                <ParagraphSmall tailwind="text-[14px]">Search by category</ParagraphSmall>
                            </div>
