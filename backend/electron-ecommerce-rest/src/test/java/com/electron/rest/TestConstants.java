...
public class TestConstants {
    ...
    public static final String REGISTER_DTO_EMAIL = "registerTest@test.com";
    public static final String REGISTER_DTO_PASSWORD = "registerpassword";
    public static final boolean REGISTER_DTO_SUBSCRIPTION = false;
    ...
    public static final Long AWAITING_ACTIVE_STATUS_ID = 2L;
    public static final String AWAITING_ACTIVATION = "AWAITING ACTIVATION";
